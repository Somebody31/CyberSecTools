<?php
// Modern UI for Iran Firewall Test Tool, inspired by reverse-mx-lookup
require_once __DIR__ . '/backend.php';

function render_header() {
    echo '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>Iran Firewall Test</title>';
...
function render_main() {
    ...
    echo '<h1>Iran Firewall Test</h1>';
    echo '<div class="desc">Test if a domain is blocked by the Iranian firewall. Useful for censorship research and accessibility checks.</div>';
    ...
    if ($query !== '') {
        ...
        echo '<div class="results-header" style="margin-top:0;">Firewall test result for <b>' . htmlspecialchars($query) . '</b></div>';
        if ($tab === 'json') {
            $json = [
                "query" => ["tool" => "iran-firewall-test", "domain" => $query],
